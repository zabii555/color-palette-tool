    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 pt-20 pb-16 shadow-[0_25px_120px_rgba(212,175,55,0.22)] glass">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 luxury-text">Lexure</h1>
      ...
      <section className="mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <div className="bg-gray-900 border border-yellow-500/20 rounded-2xl p-6 shadow-[0_18px_50px_rgba(212,175,55,0.14)] transform transition duration-300 hover:scale-105">
            ...
            <div className="bg-gray-900 border border-yellow-500/20 rounded-2xl p-6 shadow-[0_18px_50px_rgba(212,175,55,0.14)] transform transition duration-300 hover:scale-105 lg:col-span-2">
              <div className="text-4xl mb-3">5️⃣</div>
              <h3 className="text-lg font-semibold text-white mb-2">Export CSS</h3>
              <p className="text-gray-400 text-sm">Click the "Copy CSS" button to export :root variables for use in your projects.</p>
            </div>
          </div>
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-gradient-to-br from-slate-800 to-slate-700 rounded-xl glass hover-glow shadow-[0_25px_80px_rgba(212,175,55,0.25)] p-8 md:p-12 mb-12 border border-yellow-500 border-opacity-20 hover:border-opacity-40 transition-all duration-300">
          <div className="flex flex-col items-center">
            ...
            <button onClick={() => fileInputRef.current.click()} className="bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-black font-bold py-3 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg">
              Choose Image
            </button>
            ...
            <div className={uploadedImage ? 'lg:col-span-2' : 'lg:col-span-3'}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {colors.map((color, index) => (
                  <div key={index} className="bg-slate-800 rounded-lg overflow-hidden glass hover-glow shadow-[0_25px_50px_rgba(212,175,55,0.18)] border border-yellow-500 border-opacity-20 hover:border-opacity-40 transition-all duration-300 transform hover:scale-105">
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => copyToClipboard(color.hex, index)} className={`flex-1 py-2 px-3 rounded font-semibold transition-all duration-300 ${copiedIndex === index ? 'bg-green-600 text-white' : 'bg-gradient-to-r from-yellow-400 to-yellow-500 text-black hover:from-yellow-500 hover:to-yellow-600'}`}>
                          {copiedIndex === index ? '✓ Copied' : 'Copy Hex'}
                        </button>
                        <button onClick={() => copyToClipboard(`rgb(${color.rgb[0]}, ${color.rgb[1]}, ${color.rgb[2]})`, index)} className={`flex-1 py-2 px-3 rounded font-semibold transition-all duration-300 ${copiedIndex === index ? 'bg-green-600 text-white' : 'bg-slate-700 text-yellow-400 hover:bg-slate-600'}`}>
                          Copy RGB
                        </button>
                      </div>
                    </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button onClick={() => copyToClipboard(customColor, null, true)} className={`py-2 px-6 rounded font-semibold transition-all duration-300 ${copiedCustom ? 'bg-green-600 text-white' : 'bg-gradient-to-r from-yellow-400 to-yellow-500 text-black hover:from-yellow-500 hover:to-yellow-600'}`}>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button onClick={() => { const rgb = hexToRgb(customColor); copyToClipboard(`rgb(${rgb.r}, ${rgb.g}, ${rgb.b})`, null, true); }} className={`py-2 px-6 rounded font-semibold transition-all duration-300 ${copiedCustom ? 'bg-green-600 text-white' : 'bg-slate-700 text-yellow-400 hover:bg-slate-600'}`}>
                      {copiedCustom ? '✓' : 'Copy'}
                    </button>
                  </div>
                </div>
